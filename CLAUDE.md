# BhashaMitra - Claude Code Project Memory

> This file provides context to Claude Code. It is automatically read when working in this project.
...
│   └── bhashamitra_claude_code_guide.md
│
...
- [ ] Peppi AI Chat (`/peppi` page with Claude Haiku integration)
...
- `bhashamitra_claude_code_guide.md` - Claude Code specific guide
...
- [ ] Interactive Peppi chat (Claude Haiku)
