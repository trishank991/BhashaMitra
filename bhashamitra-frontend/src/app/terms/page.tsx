        ...
        >
          <motion.div variants={fadeInUp} className="bg-white rounded-2xl shadow-md p-8 mb-8">
            ...
            <p className="text-gray-700 mb-6">
              Welcome to BhashaMitra! These Terms of Service (&quot;Terms&quot;) govern your use of the BhashaMitra
              website, mobile applications, and related services (collectively, the &quot;Service&quot;) operated by
              BhashaMitra (&quot;we,&quot; &quot;us,&quot; or &quot;our&quot;).
            </p>

            <p className="text-gray-700 mb-6 bg-blue-50 p-4 rounded-lg">
              <strong>Important:</strong> BhashaMitra is designed for families. Parents or legal guardians
          ...
          <motion.div variants={fadeInUp} className="bg-white rounded-2xl shadow-md p-8 mb-8">
            ...
            <p className="text-gray-700 mb-4">
              By accessing or using BhashaMitra, you agree to be bound by these Terms and our Privacy Policy.
          ...
          <motion.div variants={fadeInUp} className="bg-white rounded-2xl shadow-md p-8 mb-8">
            ...
            <p className="text-gray-700 mb-4">BhashaMitra provides:</p>
            <ul className="list-disc pl-6 mb-6 text-gray-700">
          ...
          <motion.div variants={fadeInUp} className="bg-white rounded-2xl shadow-md p-8 mb-8">
            ...
            <p className="text-gray-700 mb-4">
              ...
              are owned by BhashaMitra and are protected by copyright, trademark, and other intellectual
              property laws.
            </p>
          ...
          <motion.div variants={fadeInUp} className="bg-white rounded-2xl shadow-md p-8 mb-8">
            ...
            <p className="text-gray-700 mb-4">
              ...
              using BhashaMitra will result in specific learning outcomes. Language learning depends on
              individual effort and practice.
            </p>

            <h3 className="text-xl font-semibold text-gray-900 mb-3">8.3 Limitation of Liability</h3>
            <p className="text-gray-700 mb-6">
              To the maximum extent permitted by law, BhashaMitra shall not be liable for any indirect,
          ...
          <motion.div variants={fadeInUp} className="bg-white rounded-2xl shadow-md p-8 mb-8">
            ...
            <p className="text-gray-700 mb-6">
              You agree to indemnify and hold BhashaMitra harmless from any claims, damages, losses, or
          ...
          <motion.div variants={fadeInUp} className="bg-white rounded-2xl shadow-md p-8 mb-8">
            ...
            <ul className="list-disc pl-6 mb-6 text-gray-700">
              <li><strong>Entire Agreement:</strong> These Terms, along with our Privacy Policy, constitute the entire agreement between you and BhashaMitra</li>
          ...
          <motion.div variants={fadeInUp} className="bg-white rounded-2xl shadow-md p-8">
            ...
            <div className="bg-gray-50 p-6 rounded-lg">
              <p className="text-gray-700 mb-2"><strong>BhashaMitra</strong></p>
      ...
      <footer className="bg-teal-800 text-white py-8 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center">
          <p className="text-white/60 text-sm">
            © 2025 BhashaMitra. Made with care in Auckland, New Zealand
          </p>
