...
HINDI_CHALLENGES = [
    # ========== GREETINGS (5 challenges) ==========
    {
        ...
        "display_order": 1,
        "points_reward": 20,
        "peppi_intro": "Let's say hello in Hindi! Listen carefully...",
        "peppi_perfect": "WOW! Perfect namaste! You sound like a native speaker! 🙏",
        "peppi_good": "Very good! Your namaste is getting better! Keep practicing!",
        "peppi_try_again": "Good try! Let's practice namaste again - na-mas-te!",
    },
    {
        "word": "धन्यवाद",
